const CACHE="rithyna-meds-v3.1";
const ASSETS=["./","./index.html","./blood-tests.html","./manifest.webmanifest","./icon.svg","./message-enhancements.js?v=3.0","./medication-manager.js?v=3.0","./nav-tabs.js?v=3.1"];
...
self.addEventListener("fetch",e=>{
  ...
  if(e.request.mode==="navigate"||u.pathname.endsWith("/index.html")||u.pathname==="/"){
    e.respondWith(fetch(e.request).then(async r=>{
      ...
      if(!html.includes("nav-tabs.js")) html=html.replace("</body>",'<script src="./nav-tabs.js?v=3.1"></script></body>');
